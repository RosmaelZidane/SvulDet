...
class LitSvulDetGAT(LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        # preds_nodes = torch.tensor(self.val_preds_nodes)
        # labels_nodes = torch.tensor(self.val_labels_nodes)
    ...
    def on_test_epoch_end(self):
        ...
        # save prediction label for verification =======================================================================================
        ...
        node_pre.to_csv(f"{utls.outputs_dir()}/nodes_prediction.cvs", index = False)
...
if __name__ == '__main__':
    ...
    config_grid = {
        ...
        'batch_size':  1, 
        'num_heads': 4,
        'check_monitor': 'val_f1', # val_acc, or 'val_f1' 
        'hidden_feats': [64, 256], 
        'dropout': [0.4],
        'lr': [1e-5, 1e-4, 2e-4, 5e-4], # [5e-5, 1e-4, 2e-4, 5e-4],
    }
